console.log("server is running!")
        ...
        <section className="container">
          ...
          <ul>
            ...
            <li><b>Услуга на проводе, во время собеса я тоже буду на проводе, и подскажу в трудную минуту(Одна голова хорошо, а две лучше)</b>
            </li>
          </ul>
          <a href="#8" className="btn btn-danger">Заказать</a>
        </section>
        <section className="container">
